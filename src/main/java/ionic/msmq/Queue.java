...
public class Queue {
    ...
    public Queue(String queueName, int access, boolean isTransactional) throws MessageQueueException {
        _init(queueName, access, isTransactional);
    }


    void _init(String queueName, int access, boolean isTransactional) throws MessageQueueException {
    ...
    public static void create(String queuePath, String queueLabel, boolean isTransactional) throws MessageQueueException {
    ...
    public void send(Message msg) throws MessageQueueException {
        int rc = nativeSend(_queueHandles, msg, true);
        if (rc != 0) {
    ...
    public void send(String s) throws MessageQueueException, java.io.UnsupportedEncodingException {
        send(new Message(s, "", ""));
    }

    private Message receiveEx(Message msg, int timeout, boolean peekOnly) throws MessageQueueException {
    ...
    public Message receive(Message msg, int timeout) throws MessageQueueException {
    ...
    public Message peek(Message msg, int timeout) throws MessageQueueException {
    ...
    private native int nativeReceive(long[] queueHandles, Message msg, boolean isTransactional, int timeout, boolean peekOnly);

    private native int nativeSend(long[] queueHandles, Message msg, boolean isTransactional);
