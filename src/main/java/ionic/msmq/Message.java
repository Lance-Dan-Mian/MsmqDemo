...
public class Message {
    ...
    public void setMessage(String value) throws java.io.UnsupportedEncodingException {
        if (value == null) {
    ...
    public String getMessage() throws java.io.UnsupportedEncodingException {
        return new String(_message, "UTF-16LE");
    }
    ...
    public Message(String message, String label, String correlationId) throws java.io.UnsupportedEncodingException {
        setMessage(message);
        _label = label;
